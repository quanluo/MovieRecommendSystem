...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "/Users/josentong/IdeaProjects/MovieRecommendSystem/recommender/DataLoader/src/main/resources/movies.csv"
  val RATING_DATA_PATH = "/Users/josentong/IdeaProjects/MovieRecommendSystem/recommender/DataLoader/src/main/resources/ratings.csv"
  val TAG_DATA_PATH = "/Users/josentong/IdeaProjects/MovieRecommendSystem/recommender/DataLoader/src/main/resources/tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://172.16.194.102:27017/recommender",
  ...
  def storeDataInES(movieDF: DataFrame)(implicit eSConfig: ESConfig): Unit ={
    ...
    //将 TransportHosts 添加到 esClient 中
